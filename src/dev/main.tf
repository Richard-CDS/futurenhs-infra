...
module "app-gateway" {
  ...
  forum_app_fqdn                              = module.app-services.app_service_fqdn_forum
  forum_app_key_vault_certificate_secret_id   = module.key-vault.key_vault_certificate_secret_id_forum_https
  forum_app_key_vault_certificate_name        = module.key-vault.key_vault_certificate_name_forum_https
